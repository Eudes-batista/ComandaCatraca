...
public class GeradoDeArquivoXMLCatraca {
    ...
    private final File arquivoConfiguracao;

    private static GeradoDeArquivoXMLCatraca geradoDeArquivoXMLCatraca = null;

    private GeradoDeArquivoXMLCatraca() {
        this.arquivoConfiguracao = new File("config.txt");
    }
    ...
    private String buscarConfiguracao() throws IOException {
        return Files.newBufferedReader(this.arquivoConfiguracao.toPath()).readLine();
    }
